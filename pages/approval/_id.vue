<template>
  <div>
    <div class="homepage-container">
      <div class="pv4">
        <nuxt-link to="/approval" class="btn btn--grey-outline">
          <svg
            width="7"
            height="10"
            viewBox="0 0 7 10"
      ...
      <div class="pv4 flex flex-wrap details-section justify-between">
        <div>
          <div class="flex flex-column">
            <h3 class="dark fs-normal fw7 pv3 f3">
              A mini self contain apartment
            </h3>
            <ul class="flex flex-wrap featured-prop-ul">
              <li>
                <p><span class="rounded-grey-dot"></span>1 bedroom</p>
              </li>
              <li>
                <p><span class="rounded-grey-dot"></span>1 bathroom</p>
              </li>
            </ul>
        ...
        <div>
          <div class="details-card pa4 flex flex-column">
            ...
            <div class="flex bt b--light-gray pt4">
