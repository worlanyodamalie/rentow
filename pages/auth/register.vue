<template>
  <div>
    ...
    <p class="fw7 f3 dark pb4">Welcome! Please create your account.</p>
    <!-- <p class="grey fs-normal normal pb2">
    ...
    <div class="flex pb2">
      <div class="register-radio">
        <input
          id="renter"
          v-model="registerData.profile"
          type="radio"
          name="rentow_profile"
          value="renter"
        />
        <label for="renter"></label>
        <span class="dark fw4 fs-normal grey--6 v-mid mh2"
          >Renter's profile</span
        >
      </div>
      <div class="mh2 register-radio">
        <input
          id="agent"
          v-model="registerData.profile"
          type="radio"
    ...
    <form @submit.prevent="register">
      ...
      <div class="pv3">
        <input
          ...
          class="w-100"
          placeholder="Re-enter your preferred password"
          type="password"
          name="re-password"
          autocomplete="current-password"
          required
      ...
      <div class="pv3">
        <button type="submit" class="btn btn--green w-100">
          <div class="flex justify-center">
            ...
            <span v-show="isloading === false">Register</span>
          </div>
        </button>
      </div>
      <div class="bb b--light-gray">
        <p class="pt3 pb4 db tc cursor">
          Have an account?<nuxt-link
            to="/auth/login"
            class="ph2 green fw7 fs-normal text-underline-none"
            >Log in</nuxt-link
          >
        </p>
      </div>
      <div class="pt3">
        <p class="fs-normal normal lh-copy tc">
          By clicking on “Register”, you have read and agreed to
        </p>
        <p class="lh-copy tc">
          <span class="green fw7 fs-normal">Rentow's privacy policy</span> and
          <span class="green fw7 fs-normal">Terms of use</span>
        </p>
      </div>
    </form>
  </div>
    ...
    async register() {
      try {
        ...
        const user = await this.$axios.post("/register", {
          ...
          profile: this.registerData.profile,
        });
